...
public class CreateTables {
  ...
  public static void create(String jdbcUrl) {
    ...
    String usersTable = "create table public.users " +
      "(id       serial      primary key," +
      " login    varchar(50) not null constraint users_pk unique," +
      " password varchar(50) not null)";

    String fundsTable = "create table public.funds " +
      "(id       serial   primary key," +
      " id_user  integer  not null  references public.users  on delete cascade," +
      " date     date     not null," +
      " balance  double precision not null)";

    String operationsTable = "create table public.operations " +
      "(id           serial   primary key," +
    ...
    String transactionsTable = "create table public.transactions " +
      "(id              serial   primary key," +
